...
def load_data():
    ...
    df_installed.columns = df_installed.columns.str.strip().str.replace("‎", "")
    ...
    if "Installation Date" not in df_installed.columns:
        st.error("'Installation Date' column not found in the installed sites sheet.")
        st.stop()
